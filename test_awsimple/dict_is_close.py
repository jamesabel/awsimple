...
class DictIsClose:
    ...
    @typechecked()
    def __init__(self, x, y, rel_tol: Union[float, None] = None, abs_tol: Union[float, None] = None, divergences: ValueDivergences = ValueDivergences()):
        self._x = x
        self._y = y
...
@typechecked()
def dict_is_close(x, y, rel_tol: Union[float, None] = None, abs_tol: Union[float, None] = None):
    """
