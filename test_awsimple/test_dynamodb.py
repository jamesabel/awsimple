...
def test_dynamodb():
    ...
    dynamodb_access.create_table(test_awsimple_str, "id")
    ...
    table_contents = dynamodb_access.scan_table_cached(test_awsimple_str, cache_life=timedelta(seconds=1).total_seconds())
    check_table_contents(table_contents)
    table_contents = dynamodb_access.scan_table(test_awsimple_str)
    check_table_contents(table_contents)
    table_contents = dynamodb_access.scan_table_cached(test_awsimple_str, cache_life=timedelta(hours=1).total_seconds())
    check_table_contents(table_contents)
